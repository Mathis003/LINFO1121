...
public class IncrementalHash
{
     ...
     */
    /*
     * Hint1: To compute hash[t]  in O(1) you should not iterate over M entries of t, by developing h[t], you should
            realize that is has a lot of common with h[t-1] = previousHash. The RM values computed above might help
            you as well in the computation.
    ...
    {
        // BEGIN : STUDENT
        int previous = (previousHash + Q - (t[from - 1] * RM) % Q) % Q;
